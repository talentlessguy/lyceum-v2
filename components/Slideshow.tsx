...
const PrevButton = ({ enabled, onClick }) => (
  <button aria-label="prev" className="embla__button embla__button--prev" onClick={onClick} disabled={!enabled}>
...
const NextButton = ({ enabled, onClick }) => (
  <button aria-label="next" className="embla__button embla__button--next" onClick={onClick} disabled={!enabled}>
